module soc_top (
  ...
  wire [11:0] mnist_awaddr;
  wire        mnist_awvalid;
  wire        mnist_awready;
  wire [31:0] mnist_wdata;
  wire [3:0]  mnist_wstrb;
  wire        mnist_wvalid;
  wire        mnist_wready;
  wire [1:0]  mnist_bresp;
  wire        mnist_bvalid;
  wire        mnist_bready;
  wire [11:0] mnist_araddr;
  wire        mnist_arvalid;
  wire        mnist_arready;
  wire [31:0] mnist_rdata;
  wire [1:0]  mnist_rresp;
  wire        mnist_rvalid;
  wire        mnist_rready;
  ...
  axi_interconnect axi_interconnect (
                     ...
                     // mnist
                     .mnist_awaddr(mnist_awaddr),
                     .mnist_awvalid(mnist_awvalid),
                     .mnist_awready(mnist_awready),
                     .mnist_wdata(mnist_wdata),
                     .mnist_wstrb(mnist_wstrb),
                     .mnist_wvalid(mnist_wvalid),
                     .mnist_wready(mnist_wready),
                     .mnist_bresp(mnist_bresp),
                     .mnist_bvalid(mnist_bvalid),
                     .mnist_bready(mnist_bready),
                     .mnist_araddr(mnist_araddr),
                     .mnist_arvalid(mnist_arvalid),
                     .mnist_arready(mnist_arready),
                     .mnist_rdata(mnist_rdata),
                     .mnist_rresp(mnist_rresp),
                     .mnist_rvalid(mnist_rvalid),
                     .mnist_rready(mnist_rready)
                   );
  ...
  axi_mnist mnist_inst (
              .clk(clk),
              .resetn(resetn),
              .s_axi_awaddr(mnist_awaddr),
              .s_axi_awvalid(mnist_awvalid),
              .s_axi_awready(mnist_awready),
              .s_axi_wdata(mnist_wdata),
              .s_axi_wstrb(mnist_wstrb),
              .s_axi_wvalid(mnist_wvalid),
              .s_axi_wready(mnist_wready),
              .s_axi_bresp(mnist_bresp),
              .s_axi_bvalid(mnist_bvalid),
              .s_axi_bready(mnist_bready),
              .s_axi_araddr(mnist_araddr),
              .s_axi_arvalid(mnist_arvalid),
              .s_axi_arready(mnist_arready),
              .s_axi_rdata(mnist_rdata),
              .s_axi_rresp(mnist_rresp),
              .s_axi_rvalid(mnist_rvalid),
              .s_axi_rready(mnist_rready),
