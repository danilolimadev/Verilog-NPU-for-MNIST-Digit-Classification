module axi_interconnect (
    ...
    // mnist
    output wire [11:0] mnist_awaddr,
    output wire        mnist_awvalid,
    input  wire        mnist_awready,
    output wire [31:0] mnist_wdata,
    output wire [3:0]  mnist_wstrb,
    output wire        mnist_wvalid,
    input  wire        mnist_wready,
    input  wire [1:0]  mnist_bresp,
    input  wire        mnist_bvalid,
    output wire        mnist_bready,
    output wire [11:0] mnist_araddr,
    output wire        mnist_arvalid,
    input  wire        mnist_arready,
    input  wire [31:0] mnist_rdata,
    input  wire [1:0]  mnist_rresp,
    input  wire        mnist_rvalid,
    output wire        mnist_rready
);
    ...
    localparam mnist_BASE = 32'h6000_0000;
    ...
    wire w_sel_mnist = (m_awaddr[31:12] == mnist_BASE[31:12]);
    ...
    wire r_sel_mnist = (m_araddr[31:12] == mnist_BASE[31:12]);
    ...
    assign mnist_awvalid = m_awvalid && w_sel_mnist;
    ...
    assign mnist_awaddr = m_awaddr[11:0];
    ...
    assign mnist_wvalid = m_wvalid && w_sel_mnist;
    ...
    assign mnist_bready = m_bready;

    // mux de bvalid/bresp pelo próprio bvalid (mais robusto que sel)
    assign m_bvalid = ram_bvalid | gpio_bvalid | uart_bvalid | spi_bvalid | i2c_bvalid | timer_bvalid | mnist_bvalid;
    ...
    assign m_bresp  = ram_bvalid    ? ram_bresp   :
                      ...
                      mnist_bvalid ? mnist_bresp : 2'b00;
    ...
    assign mnist_arvalid = m_arvalid && r_sel_mnist;
    ...
    assign mnist_araddr = m_araddr[11:0];
    ...
    assign mnist_rready = m_rready;

    assign m_rvalid = ram_rvalid | gpio_rvalid | uart_rvalid | spi_rvalid | i2c_rvalid | timer_rvalid | mnist_rvalid;
    ...
    assign m_rdata  = ram_rvalid    ? ram_rdata    :
                      ...
                      mnist_rvalid ? mnist_rdata : 32'hDEAD_BEEF;
    ...
    assign m_rresp  = ram_rvalid    ? ram_rresp    :
                      ...
                      mnist_rvalid ? mnist_rresp : 2'b00;
